...
<head>
    ...
    <link rel="stylesheet" href="css/friends_favourite.css">
    <title>friend favourite</title>
    <script src="js/friends_favourite.js"></script>
...
<div class='box'>
    <header class='nav' id='nav'>
        ...
        <%
            if (request.getAttribute("load") != "1") {
                request.getRequestDispatcher("friendFavouriteServlet").forward(request, response);
            }
        %>
    </header>
    <br><br><br><br>
    ...
    <filter id="filter">
        <!-- 图片展示 -->
        <ul class="first">${requestScope.name}的收藏</ul>
                                ...
                                <ul class='photo' name='ul'>
                                    <p style='position: relative;left: 25px;top: 25px;'>
                                        <a href='./details.jsp?id=${ele.id}'><img src='./img/travel-images/small/${ele.path}'
                                                                                  onload='Zoom(this,400,250)' name='img' alt="friendfavourite"></a>
                                    </p>
                                    <div name='div'>
